...
import           AdventData (day10, day10ex01, day10ex02, day10ex03, day10ex04,
                             day10ex05, day10ex06)
...
visCount grid cell =
    let rays = mapMaybe (rayOf cell) grid in let len = length (groupBy grpPred $ sort rays) in (len, cell)
